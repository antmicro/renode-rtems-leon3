...
wget --progress=bar 'https://www.gaisler.com/anonftp/bcc2/bin/bcc-2.2.0-gcc-linux64.tar.xz'
tar xf bcc-2.2.0-gcc-linux64.tar.xz

wget --progress=bar 'https://www.gaisler.com/products/grlib/grlib-gpl-2021.2-b4267.tar.gz'
